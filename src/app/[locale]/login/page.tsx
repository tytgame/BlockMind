          ...
          <div className="relative p-8 rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/80 to-gray-950/80 backdrop-blur-xl shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <Button
                ...
                size="lg"
                className="w-full bg-white hover:bg-gray-300 text-gray-900 font-medium py-6 rounded-xl transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
              >
              ...
              <form onSubmit={(e) => { void handleEmailSubmit(e); }} className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-sm font-medium py-6 rounded-xl transition-all duration-200 disabled:opacity-50"
                >
              ...
              <p className="text-center text-xs text-gray-500 mt-6">
                {t('terms')}{' '}
                <Link href="/terms" className="text-blue-400 hover:text-blue-300 transition-colors">{t('termsOfService')}</Link>{' '}
                {t('and')}{' '}
                <Link href="/privacy" className="text-blue-400 hover:text-blue-300 transition-colors">{t('privacyPolicy')}</Link>
                {t('agree')}
              </p>
            </div>
          </div>
